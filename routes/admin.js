...
router.post("/addBrand", storage.single("image_1"), function (req, res, next) {
  const image_1 = req.file.filename;
  adminHelper
    .addABrand(req.body, image_1)
    .then((response) => {
...
router.post(
  ...
  (req, res) => {
    ...
    const image_4 = req.files.image_4
      ...
      : req.body.image_4;
    adminHelper
      .updateProduct(req.body, productId, image_1, image_2, image_3, image_4)
      .then((response) => {
        res.redirect("/admin/viewProducts");
      });
  }
